            ...
            <div className="w-72 max-w-full px-4">
              ...
              >
                {pathUrl !== "/" ? (
                  <>
                    <Image
                      src={`/images/logo/logo_horizontal_light_mode.svg`}
                      alt="logo"
                      width={240}
                      height={30}
                    ...
                    />
                    <Image
                      src={`/images/logo/logo_horizontal_dark_mode.svg`}
                      alt="logo"
                      width={240}
                      height={30}
                  ...
                  <>
                    <Image
                      src={`${sticky
                        ? "/images/logo/logo_horizontal_light_mode.svg"
                        : "/images/logo/logo_horizontal_dark_mode.svg"
                        }`}
                      alt="logo"
                      width={160}
                      height={30}
                      ...
                      menuItem.path ? (
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            ...
                            <button
                              onClick={() => { scrollToSection(menuItem?.path == null ? "" : menuItem.path); }}
